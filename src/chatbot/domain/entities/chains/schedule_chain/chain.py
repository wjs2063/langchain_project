from chatbot.domain.entities.chat_models.chat_models import base_chat
from chatbot.domain.entities.chains.schedule_chain.prompt import schedule_prompt
from chatbot.domain.entities.chains.schedule_chain.schema import ScheduleCommandModel
from langchain_core.output_parsers import JsonOutputParser
from chatbot.domain.entities.chains.schedule_chain.prompt import (
    schedule_response_prompt,
)
from chatbot.infra.exeternal_apis.google.calendar.handler import GoogleCalendarHandler
import os
